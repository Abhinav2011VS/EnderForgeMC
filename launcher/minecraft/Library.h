...
private: /* methods */
    /// the default storage prefix used by EnderForgeMC
...
protected: /* data */
    ...
    /// DEPRECATED: EnderForgeMC-specific absolute URL. takes precedence over the implicit maven repo URL, if defined
    QString m_absoluteURL;

    /// EnderForgeMC extension - filename override
    QString m_filename;

    /// DEPRECATED EnderForgeMC extension - display name
    QString m_displayname;

    /**
     * EnderForgeMC-specific type hint - modifies how the library is treated
     */
    QString m_hint;

    /**
     * storage - by default the local libraries folder in EnderForgeMC, but could be elsewhere
     * EnderForgeMC specific, because of FTB.
     */
